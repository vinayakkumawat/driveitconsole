        ...
        <div className="flex items-start gap-4 mt-8 w-full">
          <div className="w-full">
            ...
            <div className="flex mt-4 w-full">
              <div className="bg-white rounded-lg w-full flex justify-center items-center gap-2 p-4 cursor-pointer">
                <Image
                  ...
                  height={20}
                />
                <span className="font-medium">הוספת נסיעה חדשה</span>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-4">
            <div>
              <Input className="w-56 h-8 pl-8 bg-white" placeholder="חיפוש" />
            </div>
